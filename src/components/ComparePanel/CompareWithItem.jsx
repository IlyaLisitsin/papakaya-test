...
export const CompareWithItem = (props) => {
    ...
    const productMeasures = measures(props.product, compareWithItemCalculations.product.size, props.currentMeasure);
    const itemMeasures = measures(props.item, compareWithItemCalculations.item.size, props.currentMeasure);
